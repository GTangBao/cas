...
public class AuthenticationExceptionHandler {
    ...
    static {
        ...
        DEFAULT_ERROR_LIST.add(com.goodidea.sso.exception.CaptchaException.class);
        DEFAULT_ERROR_LIST.add(com.goodidea.sso.exception.DisableAccountException.class);
        DEFAULT_ERROR_LIST.add(com.goodidea.sso.exception.LoginCountException.class);
        DEFAULT_ERROR_LIST.add(com.goodidea.sso.exception.LockedException.class);
        DEFAULT_ERROR_LIST.add(com.goodidea.sso.exception.RequestUrlException.class);
    }
