							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="save" method="post" name="form1" id="form1" >
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="name"  placeholder="请输入权限名称"  maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="alias" id="alias"   placeholder="请输入权限别称"  maxlength="100" class="col-xs-10 col-sm-5" onblur="checkAlias(this.value)"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<label>
												<input name="isEnabled" value="0" type="radio" class="ace"  checked="checked"/>
