							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="save" method="post" name="form1" id="form1" >
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="name"  placeholder="输入应用系统名称"  maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="alias" id="alias"   placeholder="请输入应用别称"  maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="code" id="code"   placeholder="请输入应用系统标识"  maxlength="100" class="col-xs-10 col-sm-5" onblur="checkCode(this.value)"/>
										</div>
									</div>
									...
									<div class="space-4"></div>
										...
										<div class="col-sm-9">
											<input type="text" name="url" id="url"   placeholder="请输入应用系统域名"  maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="space-4"></div>
										...
										<div class="col-sm-9">
											<input type="text" name="port" id="port"   placeholder="请输入应用端口"  maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<label>
												<input name="isEnabled" value="3" type="radio" class="ace"  checked="checked"/>
