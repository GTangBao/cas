							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="update" method="post" name="form1" id="form1" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="name"  placeholder="请输入角色名称" value="${role.name}" maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="alias" id="alias"   placeholder="请输入角色别称" value="${role.alias}"  maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="space-4"></div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea class="col-xs-10 col-sm-5 " name="description" maxlength="200" placeholder="请输入角色描述">${role.description}</textarea>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<label>
												<input name="enabled" value="1" type="radio" class="ace"  <#if role.enabled ==1>checked="checked" </#if>/>
												<span class="lbl"> 是</span>
											</label>
											
											<label>
												<input name="enabled" value="0" type="radio" class="ace"   <#if role.enabled ==0>checked="checked" </#if>/>
