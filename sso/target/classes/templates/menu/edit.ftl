							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="update" method="post" name="form1" id="form1" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" name="name" value="${menu.name}" placeholder="请输入菜单名称" maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="alias" name="alias" value="${menu.alias}" placeholder="请输入菜单别称" maxlength="100" class="col-xs-10 col-sm-5"  onblur="checkAlias(this.value)"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="url" name="url" value="${menu.url}" placeholder="请输入菜单路径" maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<#list systems as system>
												<#if menu.systems ??>
													<label>
														<input type="radio" <#if system.id== menu.systems.id> checked="checked" </#if>  name="systemId" value="${system.id}"  type="radio" class="ace" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-3">权限</label>
										<div class="col-sm-9">
												<div class="checkbox">
													<#list privileges as privilege>
														<label>
															<input name="privilegeIds" type="checkbox" <#if menu.privileges?seq_contains(privilege)> checked="checked" </#if> value="${privilege.id}" class="ace" />
