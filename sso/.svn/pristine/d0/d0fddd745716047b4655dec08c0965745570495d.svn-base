							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="update" method="post" name="form1" id="form1" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="username" name="username" placeholder="请输入用户名" value="${user.username}" readonly="readonly" maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="password" name="password" placeholder="请输入密码" value="${user.password}" maxlength="100" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group ">
										...
										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5" id="deptId" onclick="getTree();"  name="deptId">
													<#if user.dept ??>
														<option value="${user.dept.id}">${user.dept.name}</option>
														</#if>
										...
										<div class="col-sm-9">
												<div class="checkbox">
													<#list systems as system>
														<label>
															<input name="requestUrl" <#if user.requestUrl?? && user.requestUrl?contains(system.url)> checked="checked"</#if> type="checkbox" value="${system.url}" class="ace" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<label>
												<input type="radio" <#if user.enabled ==1>checked="checked" </#if> name="enabled" value="1"  type="radio" class="ace" />
												<span class="lbl"> 是</span>
											</label>
											
											<label>
												<input type="radio" <#if user.enabled ==0>checked="checked" </#if> name="enabled" value="0" type="radio" class="ace"  />
