            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="save" method="post" name="form1" id="form1">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="name" name="name" placeholder="请输入部门名称" maxlength="100"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="deptType" name="deptType" placeholder="请输入部门类型" maxlength="100"
                                   class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="deptLevel" name="deptLevel" placeholder="请输入部门等级" maxlength="100"
                                   class="col-xs-10 col-sm-5"/>
                        </div>
                    </div>
